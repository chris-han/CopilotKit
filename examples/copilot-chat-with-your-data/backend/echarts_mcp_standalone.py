...
This is a simplified standalone server that provides ECharts MCP tools
without dependencies on the main FastAPI application.
"""
    ...
    async def get_chart(
        ...
        if isinstance(data, dict) and "values" in data:
            ...
            if values and len(values) > 0:
                first_row = values[0] if isinstance(values[0], list) else [values[0]]
